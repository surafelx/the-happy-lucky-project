...
export const letter: Letter = {
  ...
  body: [
    p("Three years, six months and twenty-one days ago, I had a long and intense night. I still don't know exactly how to explain that night. I could try to describe what happened, but I don't think that is really the important part. __What matters more to me is what came after.__ What it left me thinking about."),
    ...
    image("Happy, Lucky, Chacho and me. Where the name comes from.", "The siblings the project is named after", "rose"),
    ...
    image("A Sunday morning. Kids being kids.", "Children at a Sunday workshop", "gold"),
    ...
    image("Listening first: the people already doing the work.", "A conversation with a community organisation", "teal"),
    ...
    p("I think that matters. Because if [[Happy Lucky]] is going to mean anything, I don't want it to be built around what I imagine from a distance. __I want it to be built around listening to people who are already there.__"),
    ...
    key("Not for me."),
    key("With me."),
    image("Sunday 0. This is where it starts.", "The first Sunday", "rose"),
